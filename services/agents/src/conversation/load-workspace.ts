 ...
 * contract shapes above) and drop everything else (derived
 ...
 * covered flags instead of resetting them, and `*.feature` so a capability
 * keeps its existing file name and the rules that still hold, rather than being
 * renamed into a second file stating the same rules twice.
 *
