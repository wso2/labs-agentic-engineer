...
// Same harness as the Excalidraw prototype route's test: `createFileRoute`
// hands back its options plus stubbed hooks, so the real `validateSearch` and
...
import { Route as RouteUnderTest } from "./projects.$projectName_.json-prototype.$component";

const Route = RouteUnderTest as unknown as {
  validateSearch: (search: Record<string, unknown>) => PrototypeViewRequest;
  component: React.ComponentType;
};
const JsonPrototypeRoute = Route.component;
