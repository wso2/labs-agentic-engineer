...
//
// There is deliberately no `requirements` value. The spec interview is started
// by the BACKEND at project creation (#485); a console that injected `/start`
// as well raced it, and a stale bookmark carrying the old param must land on a
// plain spec view rather than fire a turn nobody asked for.
//
