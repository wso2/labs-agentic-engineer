...
// the whole viewport.
//
// The proof path for the new prototype model, beside the Excalidraw
// wireframe prototype at `prototype.$component`; it takes that route's name
// once the old path is removed.
//
...
export const Route = createFileRoute("/projects/$projectName_/json-prototype/$component")({
  validateSearch: validatePrototypeSearch,
  component: JsonPrototypeRoute,
});

function JsonPrototypeRoute() {
