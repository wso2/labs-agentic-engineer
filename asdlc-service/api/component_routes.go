...
func registerComponentRoutes(rt *Router, c controllers.ComponentController) {
	...
	rt.OrgScoped("GET "+prefix+"/{componentName}", c.GetComponent)

	// Build operations
	rt.OrgScoped("POST "+prefix+"/{componentName}/builds", c.TriggerBuild)
	rt.OrgScoped("GET "+prefix+"/{componentName}/builds", c.ListBuilds)
	rt.OrgScoped("GET "+prefix+"/{componentName}/builds/{buildName}", c.GetBuildStatus)
	rt.OrgScoped("GET "+prefix+"/{componentName}/builds/{buildName}/logs", c.GetBuildLogs)
	...
	rt.OrgScoped("GET "+prefix+"/{componentName}/deployments", c.ListDeployments)
	...
	rt.OrgScoped("GET "+prefix+"/{componentName}/openapi", c.GetComponentOpenAPI)
}
