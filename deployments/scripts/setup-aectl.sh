...
# for all of them; Thunder narrows the grant to whatever the caller's actual
# role holds. Omitting one here means no caller, however privileged, can ever
# get it: RFC 8707's resource indicator (VITE_THUNDER_RESOURCE, PUBLIC_THUNDER_URL
